...
// Inclure les modèles nécessaires (compatibilité sans autoloader)
require_once __DIR__ . '/../models/Employe.php';
require_once __DIR__ . '/../models/Pointage.php';

// Si le modèle Pointage est namespacé, créer un alias global pour compatibilité
if (!class_exists('Pointage') && class_exists('\PointagePro\Models\Pointage')) {
    class_alias('\PointagePro\Models\Pointage', 'Pointage');
}
// Alias supplémentaire pour compatibilité si le code utilise le namespace Pointage\Models
if (!class_exists('Pointage\\Models\\Pointage') && class_exists('\PointagePro\Models\Pointage')) {
